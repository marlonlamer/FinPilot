  ...
  return (
    <div style={{ marginTop: 16, display: "flex", gap: 12, flexWrap: "wrap" }}>
      <div style={{ flex: "1 1 320px", background: "#fff", padding: 12, borderRadius: 8, boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 700 }}>{monthlyBudget === null ? "Not set" : (formatCurrency ? formatCurrency(monthlyBudget) : `${currencySymbol}${Number(monthlyBudget).toFixed(2)}`)}</div>
